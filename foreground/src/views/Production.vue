<template>
    <div id="content">
        <div
            style="width: 100%; height: 100px; dispaly: flex; display: -webkit-flex; direction: row; align-items: center;"
        >
            <span style="witdh: 100px;">商品名称：</span>
            <el-input
                placeholder="请输入商品名称"
                ...
                style="width: 200px"
            ></el-input>
            <el-button @click="loadProduction" type="primary" style="margin-left: 20px">搜索</el-button>
        </div>
        <el-row>
            <el-col
                :span="8"
...
export default {
    methods: {
        buyAction() {
            ...
            this.$axios
                .post(Constants.SERVER_PRE_URL + '/sale/', {
